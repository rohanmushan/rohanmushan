...
class UpdateWindow:
    def __init__(self, id):
        ...
        self.genderType = ["Male", "Female", "Transgender", "others"]
        self.dateType = list(range(1, 32))
        self.monthType = ["January", "February", "March", "April", "May", "June", "July", "August", "September",
                          "October", "November", "December"]
        self.yearType = list(range(1900, 2020))
...
class DatabaseView:
    def __init__(self, data):
        ...
        # Treeview columns
        self.databaseView.column("id", width=60)
        self.databaseView.column("firstname", width=64)
        self.databaseView.column("lastname", width=65)
        self.databaseView.column("dateOfBirth", width=72)
...
class HomePage:
    def __init__(self):
        ...
        fg_color = "black"
        lbl_color = 'GREEN'
        tkinter.Label(self.homePageWindow, relief=tkinter.GROOVE, fg=fg_color, bg=bg_color, text="Home Page", font=("times new roman",30,"bold"), width=30).grid(pady=20, column=1, row=1)
    ...
    def Update(self):
        ...
        # Label
        tkinter.Label(self.updateIDWindow, text="Enter the patient ID to update", width=50).grid(pady=20, row=1)
